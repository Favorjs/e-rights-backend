...
\copy shareholders(reg_account_number,name,address,holdings,rights_issue,holdings_after,amount_due,created_at,updated_at) FROM 'C:\Users\fadebowale\Desktop\APEL-WEBSITE\linkage_register.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',');